import{LitElement,html,svg,css}from"https://unpkg.com/lit@2.0.0/index.js?module";import{live}from"https://unpkg.com/lit@2.0.0/directives/live.js?module";const CARD_VERSION="4.1.233",_needleDegreesCache=new Map,DEFAULT_MARKER={show:!0,degrees:"0",height:5,width:4,position:0,color:"#FF0000",flip:!1},DEFAULT_NEEDLE={name:"",show:!0,template:"{{ state_attr('sun.sun', 'azimuth') | float(0) }}",invert:!1,rotate:!1,color_1:"#FF0000",color_1_pos:50,color_2:"#EEEEEE",color_2_pos:50,height:100,width:10,position:-10,morph:50,curve:0,image_show:!1,image_url:"/local/community/chrono-compass-card/moon.png",image_scale:100,image_x:0,image_y:0,image_rotate:0},DEFAULT_CONFIG={background_color:"#101010",bezel_color:"#383838",bezel_width:16,compass_size:0,background_image_show:!0,background_image_url:"/local/community/chrono-compass-card/black.png",background_image_scale:100,background_image_x:0,background_image_y:0,background_image_rotate:0,needles:[{...DEFAULT_NEEDLE}],compass_rotate:!1,markers:[],cardinals_show:!0,cardinal_north:"N",cardinal_east:"E",cardinal_south:"S",cardinal_west:"W",cardinals_fontsize:10,cardinals_fontweight:400,cardinals_position:1.5,cardinals_fontcolor:"#EEEEEE",major_ticks_show:!1,major_ticks_divisions:4,major_ticks_length:6,major_ticks_width:2,major_ticks_position:-3.5,major_ticks_color:"#CCCCCC",minor_ticks_show:!0,minor_ticks_divisions:8,minor_ticks_length:3,minor_ticks_width:1.5,minor_ticks_position:-4.5,minor_ticks_color:"#AAAAAA",micro_ticks_show:!0,micro_ticks_divisions:16,micro_ticks_length:0,micro_ticks_width:2,micro_ticks_position:-6.5,micro_ticks_color:"#888888",header_show:!1,header_text:"header",header_fontsize:2,header_fontweight:400,header_position:0,header_fontcolor:"#FFFFFF",footer_show:!1,footer_text:"footer",footer_fontsize:2,footer_fontweight:400,footer_position:0,footer_fontcolor:"#FFFFFF",field_1_show:!0,field_1_template:"${compass_direction}",field_1_fontsize:1.5,field_1_fontweight:400,field_1_position:23,field_1_fontcolor:"#29B6CF",field_1_unit:"",field_1_unit_fontsize:1,field_1_unit_fontweight:400,field_1_unit_fontcolor:"#196D7C",field_2_show:!1,field_2_template:"{{ states('sensor.ws_wind_speed') | round(1) }}",field_2_unit:"km/h",field_2_fontsize:2,field_2_fontweight:400,field_2_position:50,field_2_fontcolor:"#E8E8E8",field_2_unit_fontsize:1.2,field_2_unit_fontweight:400,field_2_unit_fontcolor:"#8C8C8C",field_3_show:!0,field_3_template:"{{ state_attr('sun.sun', 'azimuth') | round(0) }}",field_3_unit:"°",field_3_fontsize:1.4,field_3_fontweight:400,field_3_position:79,field_3_fontcolor:"#808080",field_3_unit_fontsize:1.4,field_3_unit_fontweight:400,field_3_unit_fontcolor:"#606060",rotation_animation_time:.5};class ChronoCcTextfield extends LitElement{static properties={value:{type:String},type:{type:String},step:{type:String},min:{type:String},max:{type:String},placeholder:{type:String}};static styles=css`
  ...
  `;render(){return html`
      <input
        ...
        @input=${this._onInput}
      />
    `}_onInput(e){this.value=e.target.value,this.dispatchEvent(new Event("input",{bubbles:!0,composed:!0}))}}customElements.define("chrono-cc-textfield",ChronoCcTextfield);class ChronoCompassCardEditor extends LitElement{static properties={hass:{type:Object},_config:{type:Object}};setConfig(e){this._config={...DEFAULT_CONFIG,...e}}_parseNumber(e){const t=String(e).replace(",",".");if("-"===t||"-0"===t||t.endsWith("."))return null;if(t.includes(".")&&t.endsWith("0"))return null;if(""===t)return;const i=parseFloat(t);return isNaN(i)?null:i}_valueChanged(e,t){if(!this._config||!this.hass)return;let i;if(i=void 0!==t.detail?.value?t.detail.value:"HA-SWITCH"===t.target.tagName?t.target.checked:t.target.value,"number"===t.target.type){const e=this._parseNumber(i);if(null==e)return;i=e}this._config={...this._config,[e]:i},this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:this._config},bubbles:!0,composed:!0}))}_colorPicker(e,t,i){const o=/^#[0-9a-fA-F]{6}$/.test(t)?t:"#ffffff";return html`
  ...
  `}customElements.define("chrono-compass-card-editor",ChronoCompassCardEditor);class ChronoCompassCard extends LitElement{static properties={hass:{type:Object},config:{type:Object},_needleDegrees:{type:Array},_field1Value:{type:String},_field2Value:{type:String},_field3Value:{type:String},_headerValue:{type:String},_footerValue:{type:String},_markerDegrees:{type:Array},_backgroundImageUrl:{type:String},_needleImageUrls:{type:Array},_error:{type:Boolean}};constructor(){super(),this._needleDegrees=[],this._needlePrevDegrees=[],this._templateUnsubs=[],this._subscriptionsActive=!1,this._scale=1,this._field1Value="",this._field2Value="",this._field3Value="",this._headerValue="",this._footerValue="",this._markerDegrees=[],this._backgroundImageUrl="",this._needleImageUrls=[],this._error=!1}setConfig(e){this.config={...DEFAULT_CONFIG,...e}}connectedCallback(){if(super.connectedCallback(),this.config&&0===this._needleDegrees.length){const e=this._cacheKey(),t=_needleDegreesCache.get(e);t&&(this._needleDegrees=[...t.degrees],this._needlePrevDegrees=[...t.prevDegrees])}this.hass&&this.config&&!this._subscriptionsActive&&this._setupSubscriptions()}disconnectedCallback(){super.disconnectedCallback(),this._teardownSubscriptions()}willUpdate(e){if(super.willUpdate(e),this.config&&0===this._needleDegrees.length){const e=this._cacheKey(),t=_needleDegreesCache.get(e);t&&(this._needleDegrees=[...t.degrees],this._needlePrevDegrees=[...t.prevDegrees])}}_cacheKey(){return(this.config.needles||[]).map(e=>e.template).join("|")}updated(e){super.updated(e),this._scaleElements(),this.hass&&this.config&&(this._subscriptionsActive||this._setupSubscriptions())}_setupSubscriptions(){if(this._teardownSubscriptions(),!this.hass?.connection||!this.config)return;this._subscriptionsActive=!0;const e=(e,t)=>{const i=String(e);if(!i.includes("{{"))return void t(i);const o=this.hass.connection.subscribeMessage(e=>t(e.result),{type:"render_template",template:i});this._templateUnsubs.push(o)};(this.config.needles||[]).forEach((t,i)=>{e(t.template,e=>{const t=parseFloat(e);if(isNaN(t)){const e=[...this._needleDegrees];e[i]=0,this._needleDegrees=e,this._needlePrevDegrees[i]=null,0===i&&(this._error=!0)}else{const e=(t%360+360)%360,o=this._needlePrevDegrees[i]??null,l=this._needleDegrees[i]??0;if(e!==o){let t=e-(l%360+360)%360;t>180&&(t-=360),t<-180&&(t+=360);const o=[...this._needleDegrees];o[i]=l+t,this._needleDegrees=o,this._needlePrevDegrees[i]=e,_needleDegreesCache.set(this._cacheKey(),{degrees:[...o],prevDegrees:[...this._needlePrevDegrees]})}0===i&&(this._error=!1)}0===i&&this._updateCompassDirectionFields()})});for(const t of this._fieldDefs){if(!t.show){this[`_field${t.index}Value`]="";continue}const i=t.index;e(String(t.template),e=>{this[`_field${i}Value`]=String(e).replace("${compass_direction}",this.getCompassDirection(this._needleDegrees[0]??0))})}this.config.header_show&&this.config.header_text?e(this.config.header_text,e=>{this._headerValue=e}):this._headerValue="",this.config.footer_show&&this.config.footer_text?e(this.config.footer_text,e=>{this._footerValue=e}):this._footerValue="",this._markerDegrees=[],(this.config.markers||[]).forEach((t,i)=>{e(t.degrees,e=>{const t=[...this._markerDegrees];t[i]=(parseFloat(e)%360+360)%360,this._markerDegrees=t})}),this.config.background_image_show?e(this.config.background_image_url,e=>{this._backgroundImageUrl=e}):this._backgroundImageUrl="",this._needleImageUrls=[],(this.config.needles||[]).forEach((t,i)=>{if(t.image_show)e(t.image_url,e=>{const t=[...this._needleImageUrls];t[i]=e,this._needleImageUrls=t});else{const e=[...this._needleImageUrls];e[i]="",this._needleImageUrls=e}})}_updateCompassDirectionFields(){const e=this.getCompassDirection(this._needleDegrees[0]??0);for(const t of this._fieldDefs){if(!t.show)continue;const i=String(t.template);i.includes("${compass_direction}")&&(i.includes("{{")||(this[`_field${t.index}Value`]=i.replace("${compass_direction}",e)))}}get _fieldDefs(){return[{index:1,show:this.config.field_1_show,template:this.config.field_1_template},{index:2,show:this.config.field_2_show,template:this.config.field_2_template},{index:3,show:this.config.field_3_show,template:this.config.field_3_template}]}_teardownSubscriptions(){const e=this._templateUnsubs;this._templateUnsubs=[],this._subscriptionsActive=!1;for(const t of e)Promise.resolve(t).then(e=>e()).catch(()=>{})}_scaleElements(){const e=this.shadowRoot.querySelector(".compass-layer");if(!e)return;const t=e.offsetWidth;this._scale=t/120,this.style.setProperty("--cc-font-size",.08*t+"px");const i=parseFloat(this.config.bezel_width),o=parseFloat(this.config.compass_size);this.style.setProperty("--cc-bezel-width",i*this._scale+"px"),this.style.setProperty("--cc-bezel-color",this.config.bezel_color),this.style.setProperty("--cc-bg-color",this.config.background_color);const l=this.offsetWidth/120;this.style.setProperty("--cc-compass-size",o*l+"px"),this.style.setProperty("--cc-animation-duration",`${this.config.rotation_animation_time}s`);const s=this.shadowRoot.querySelector(".compass-ticks-layer");s&&this.style.setProperty("--cc-ticks-size",`${s.offsetWidth}px`)}getCompassDirection(e){const t=(e%360+360)%360,i=this.config.cardinal_north,o=this.config.cardinal_east,l=this.config.cardinal_south,s=this.config.cardinal_west;return[i,i+i+o,i+o,o+i+o,o,o+l+o,l+o,l+l+o,l,l+l+s,l+s,s+l+s,s,s+i+s,i+s,i+i+s][Math.floor((t+11.25)/22.5)%16]}_buildNeedlePath(e,t,i,o){let l=[{x:50,y:0},{x:0,y:50},{x:50,y:50+e},{x:100,y:50}];const s=Math.abs(e)/50,n=Math.sign(e)*Math.min(1,Math.abs(e)/50)*(Math.PI/2);let a=[{in:{x:1,y:0},out:{x:-1,y:0},lengthMultiplier:1},{in:{x:0,y:-1},out:{x:Math.cos(n),y:Math.sin(n)},lengthMultiplier:1},{in:{x:-1,y:0},out:{x:1,y:0},lengthMultiplier:s},{in:{x:-Math.cos(n),y:Math.sin(n)},out:{x:0,y:-1},lengthMultiplier:1}];i&&(l.forEach(e=>{e.y=-e.y}),a.forEach(e=>{e.in.y=-e.in.y,e.out.y=-e.out.y}));const r=l.map((e,i)=>{const o=t*a[i].lengthMultiplier;return{in:{x:e.x+a[i].in.x*o,y:e.y+a[i].in.y*o},out:{x:e.x+a[i].out.x*o,y:e.y+a[i].out.y*o}}}),c=[...l];r.forEach(e=>c.push(e.in,e.out));const d=-Math.min(...c.map(e=>e.y))+o;l.forEach(e=>{e.y+=d}),r.forEach(e=>{e.in.y+=d,e.out.y+=d});let h=`M ${l[0].x},${l[0].y}`;for(let e=0;e<l.length;e++){const t=(e+1)%l.length;h+=` C ${r[e].out.x},${r[e].out.y} ${r[t].in.x},${r[t].in.y} ${l[t].x},${l[t].y}`}h+=" Z";const f=[...l];r.forEach(e=>f.push(e.in,e.out));const g=f.map(e=>e.x),_=f.map(e=>e.y);return{path:h.trim().replace(/\s+/g," "),bounds:{minX:Math.min(...g),maxX:Math.max(...g),minY:Math.min(..._),maxY:Math.max(..._)}}}_renderTicks(){const e=this.config,t=50,i=[e.cardinal_north,e.cardinal_east,e.cardinal_south,e.cardinal_west],o=[{key:"major",show:e.major_ticks_show,divisions:parseInt(e.major_ticks_divisions)||4,length:e.major_ticks_length,width:e.major_ticks_width,color:e.major_ticks_color,position:e.major_ticks_position||0},{key:"minor",show:e.minor_ticks_show,divisions:parseInt(e.minor_ticks_divisions)||8,length:e.minor_ticks_length,width:e.minor_ticks_width,color:e.minor_ticks_color,position:e.minor_ticks_position||0},{key:"micro",show:e.micro_ticks_show,divisions:parseInt(e.micro_ticks_divisions)||16,length:e.micro_ticks_length,width:e.micro_ticks_width,color:e.micro_ticks_color,position:e.micro_ticks_position||0}],l=e=>Math.round(10*e)/10,s=new Set,n=[];o.forEach(o=>{const a=360/o.divisions;for(let r=0;r<o.divisions;r++){const c=l(r*a);if(s.has(c))continue;if(s.add(c),"major"===o.key&&e.cardinals_show){const o=[0,90,180,270].indexOf(c);if(-1!==o){const l=c*Math.PI/180,s=Math.sin(l),a=Math.cos(l),r=50+(t+(e.cardinals_position||0))*s,d=50-(t+(e.cardinals_position||0))*a,h=.85*e.cardinals_fontsize,f=r-h*s,g=d+h*a;n.push({type:"text",x:f,y:g,letter:i[o],fontSize:e.cardinals_fontsize,fontWeight:e.cardinals_fontweight,color:e.cardinals_fontcolor})}}if(!o.show)continue;const d=c*Math.PI/180,h=Math.sin(d),f=Math.cos(d),g=parseFloat(o.length),_=parseFloat(o.width),p=parseFloat(o.position),m=50+(t+p)*h,u=50-(t+p)*f,v=50+(t+p-g)*h,x=50-(t+p-g)*f;n.push({type:"line",x1:m,y1:u,x2:v,y2:x,color:o.color,width:_})}});const a=(e.markers||[]).map((e,t)=>({show:e.show,degrees:this._markerDegrees[t]??0,height:parseFloat(e.height),width:parseFloat(e.width),position:parseFloat(e.position),color:e.color,flip:e.flip})).map(e=>{if(!e.show)return null;const i=e.degrees*Math.PI/180,o=Math.sin(i),l=Math.cos(i),s=t+e.position,n=s+e.height,a=50+(e.flip?n:s)*o,r=50-(e.flip?n:s)*l,c=50+(e.flip?s:n)*o,d=50-(e.flip?s:n)*l,h=e.width/2,f=c+h*l,g=d+h*o,_=c-h*l,p=d-h*o;return{color:e.color,path:`M ${a},${r} L ${f},${g} L ${_},${p} Z`}}).filter(Boolean);return html`
    ...
    `}_fieldStyle(e){return`font-size:${e.fontsize}em; font-weight:${e.fontweight}; color:${e.fontcolor}; top:${e.position}%;`}_unitStyle(e){return`font-size:${e.unit_fontsize/e.fontsize}em; font-weight:${e.unit_fontweight}; color:${e.unit_fontcolor};`}render(){const e=this.config||{},t=e.needles||[],i=this._scale||1,o=this._needleDegrees[0]??0,l=e.compass_rotate?-o:0,s=[{index:1,show:e.field_1_show,unit:e.field_1_unit,fontsize:parseFloat(e.field_1_fontsize),fontweight:e.field_1_fontweight,position:e.field_1_position,fontcolor:e.field_1_fontcolor,unit_fontsize:parseFloat(e.field_1_unit_fontsize),unit_fontweight:e.field_1_unit_fontweight,unit_fontcolor:e.field_1_unit_fontcolor},{index:2,show:e.field_2_show,unit:e.field_2_unit,fontsize:parseFloat(e.field_2_fontsize),fontweight:e.field_2_fontweight,position:e.field_2_position,fontcolor:e.field_2_fontcolor,unit_fontsize:parseFloat(e.field_2_unit_fontsize),unit_fontweight:e.field_2_unit_fontweight,unit_fontcolor:e.field_2_unit_fontcolor},{index:3,show:e.field_3_show,unit:e.field_3_unit,fontsize:parseFloat(e.field_3_fontsize),fontweight:e.field_3_fontweight,position:e.field_3_position,fontcolor:e.field_3_fontcolor,unit_fontsize:parseFloat(e.field_3_unit_fontsize),unit_fontweight:e.field_3_unit_fontweight,unit_fontcolor:e.field_3_unit_fontcolor}],n=(e,t)=>e.show?html`
          ...
          <svg class="compass-needle"
            ...
            ${e.image_show&&m?svg`
              <image
                href="${m}"
                x="${n}" y="${a}"
                width="${r-n}" height="${c-a}"
                preserveAspectRatio="xMidYMid slice"
                clip-path="url(#${p})"
                transform="translate(${(r+n)/2}, ${(c+a)/2}) rotate(${e.image_rotate}) scale(${e.image_scale/100}) translate(${e.image_x}, ${e.image_y}) translate(${-(r+n)/2}, ${-(c+a)/2})"
              />
            `:svg`
              <path d="${s.path}" fill="url(#${_})" />
            `}
          </svg>
        </div>
      `};return html`
      <ha-card>
        ...
        <div class="compass-container">
          ...
          <div class="compass-rotate-group" style="transform:rotate(${l}deg)">
            ${this._renderTicks()}
