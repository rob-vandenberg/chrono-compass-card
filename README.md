...
## What is the Chrono Compass Card?

Chrono Compass Card displays a compass on your Home Assistant dashboard, driven by any entity that provides a bearing in degrees — wind direction, sun azimuth, moon position, or anything else that rotates.
...
Chrono Compass Card is very customizable. The same card, with different settings, can look like a wind speedometer, a compass or a sun tracker:
